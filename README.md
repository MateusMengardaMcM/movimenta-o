...
Compreendi os conceitos de operadores aritmeticos no javascript.
## Funcionalidades

- Ao clicar nos botoes voce podera movimentar um pequeno quadrado pela tela.
...
```bash
  git clone https://github.com/MateusMengardaMcM/movimenta-o
